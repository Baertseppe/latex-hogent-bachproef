...
\\
\\
Dit onderzoek heeft als doel om te onderzoeken welke machine learning-modellen het beste geschikt zijn voor het voorspellen van speler statistieken, gebaseerd op een literatuurstudie en experimentele vergelijkingen. We gaan verschillende modellen trainen en evalueren op dezelfde historische dataset met maatstaven zoals Mean Absolute Error (MAE) en Root Mean Squared Error (RMSE).
